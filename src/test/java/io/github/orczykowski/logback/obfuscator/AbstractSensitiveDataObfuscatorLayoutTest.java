...
class AbstractSensitiveDataObfuscatorLayoutTest {
    ...
    static class TestImplementationSensitiveDataTextDecoratorTest extends AbstractSensitiveDataObfuscatorLayout {
        @Override
